$(document).ready(function () {
    ...
    var table = $('#example').DataTable( {
        ...
        "columns": [
            ...
            { "data": "recNumber", 'width': '20%' , "className": "dt-left"},
            { "data": "billDate"  , 'width': '20%' , "className": "dt-left"},
            { "data": "recDate"  , 'width': '10%' , "className": "dt-center"},
            { "data": "traDate"  , 'width': '5%', "className": "dt-center"},
            { "data": "customer" , 'width': '5%', "className": "dt-center"},
