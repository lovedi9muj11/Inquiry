...
<body>
	...
	<div  style="padding: 30px 10px 50px 50px">
	  ...
	  <div name="error" id="error"  class="alert alert-danger alert-dismissable fade in" style="display: none; font-size: 200%;">
	    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
	    <strong>Error : </strong> รหัสผ่านไม่ถูกต้อง
	  </div>
	  <div name="success" id="success"  class="alert alert-success alert-dismissable fade in" style="display: none; font-size: 200%;">
	    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
	    <strong>ยกเลิกรายการสำเร็จ</strong>
	  </div>
	  <div name="notClear" id="notClear"  class="alert alert-danger alert-dismissable fade in" style="display: none; font-size: 200%;">
	    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
