...
CREATE TABLE `payment_invoice_manual` (
  `PAYMENT_INVOICE_MANUAL_ID` bigint(20) NOT NULL,
  ...
  `ACCOUNTSUBNO` varchar(25) DEFAULT NULL,
  ...
  `DISCOUNTBEFORVAT` decimal(10,0) NOT NULL,
  `DISCOUNTSPECIAL` decimal(10,0) NOT NULL,
  `AMOUNTTYPE` varchar(10) NOT NULL,
